...
/**
 *  还需要开发功能  https://querybuilder.js.org/demo.html 和 https://dabernathy89.github.io/vue-query-builder/
    ...
    labels: {
      ...
      default: () => {
        return {
          ...
          'addGroup': I18n.t('components.queryBuilder.add_rule'),
  ...
  methods: {
    ...
    getOperators(filter) {
      ...
      Object.keys(QueryBuilder.OPERATORS).forEach((op) => {
        var operators = QueryBuilder.OPERATORS[op]
